...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Tessa Mendoza** and I'm a fifth year senior here at Iowa State. My major is *Kinesiology and Health* with three minors in Computer Science, Data Science, and Psychology. Outside of school, I work as an undergraduate research assistant in ISU's Neurophysiology lab and am a sports analytics intern with Samford University's Center for Sports Analytics. In the future, I hope to work as a sports analyst with professional sports organizations in order to promote athlete safety and optimize player and team performance. 
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: The senior data analyst position at Hudl combines data science skills and sports knowledge with the goal of improving preparation and competition level of athletes, coaches, and athletic programs. This job is a leadership position on a Decision Science team that provides a bridge between data analysts and business leaders. Some of the tasks of this position involve writing SQL queries, running statisticsal models, and making evidence-based decisions.
    
    https://www.hudl.com/
    
    https://upload.wikimedia.org/wikipedia/commons/1/10/Hudl-logo-print-pantone.jpg
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am most interested in sports data and health care data. 
